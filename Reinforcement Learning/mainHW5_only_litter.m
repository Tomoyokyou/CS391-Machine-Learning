%% HW5 Main - Only Litter
clc; clear; close all;
inputPath = 'sidewalk_only_litter.mat';

load(inputPath);
[r, c] = size(sidewalk_only_litter);
val_litter = 2;
val_obstacle = -50;
plotSidewalk(sidewalk_only_litter, r, c, val_litter, val_obstacle);
...
for i=1:total
    reward=[reward;reshape(sidewalk_only_litter, 1, total);];
end
n = r;
for i=1:total
    for j=1:total
...
plotSidewalk(sidewalk_only_litter, r, c, val_litter, val_obstacle, path);
