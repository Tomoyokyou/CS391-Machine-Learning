%% HW5 Main
clc; clear; close all;
inputPath = 'sidewalk_3.mat';

load(inputPath);
[r, c] = size(sidewalk);
val_litter = 2;
val_obstacle = -50;
plotSidewalk(sidewalk, r, c, val_litter, val_obstacle);
...
for i=1:total
    reward=[reward;reshape(sidewalk, 1, total);];
end
n = r;
for i=1:total
    for j=1:total
...
plotSidewalk(sidewalk, r, c, val_litter, val_obstacle, path);
